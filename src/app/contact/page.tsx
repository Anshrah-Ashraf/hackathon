...
<div className="breadcrumbs">
    <Image src='shop.jpeg' alt='shop' className='w-[2000000px] h-[400px] opacity-[50%]'></Image>
      <a href="#" className="absolute inset-1 flex items-center justify-center text-black text-[30px] font-bold">Home {'>'} Contact</a> 
    </div>
        <h1 className="text-3xl font-extrabold text-gray-900 mb-8">Get In Touch With Us</h1>
